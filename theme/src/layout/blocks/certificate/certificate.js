window.jQuery(function () {
	...
	const $certificateSlider = window.jQuery('.certificate__slider');
	const $certificateCarusel = window.jQuery('.certificate__carusel');

	if( $certificateSlider.length && $certificateCarusel ) {

		$certificateCarusel.slick({
			slidesToShow: 4,
			slidesToScroll: 1,
			asNavFor: $certificateSlider,
			dots: false,
			focusOnSelect: true,
