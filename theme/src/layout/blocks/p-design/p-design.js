...
document.addEventListener("DOMContentLoaded", function (event) {
	const pDesignSlider = document.querySelectorAll('.p-design__container');

	if(pDesignSlider.length) {

		for (let i =0; i < pDesignSlider.length; i++) {
			addSliderOnResize(pDesignSlider[i] ,
				{
					slidesToShow: 2,
					infinite: false,
					slidesToScroll: 1,
