...
document.addEventListener("DOMContentLoaded", function (event) {
	...
	const typeSliderTop = document.querySelector('.js-types-top');
	const typeSliderBottom = document.querySelector('.js-types-bottom');

	if(typeSliderTop != null) {

		addSliderOnResize(typeSliderTop ,
			{
				slidesToShow: 4,
				infinite: false,
				slidesToScroll: 1,
	...
	if(typeSliderBottom != null) {

		addSliderOnResize(typeSliderBottom ,
			{
				slidesToShow: 1,
				infinite: false,
				slidesToScroll: 1,
